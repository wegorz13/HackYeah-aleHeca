...
export const ProfileInfo = () => {
    ...
    const badgeCls = "inline-flex items-center gap-1 rounded-3xl bg-gray-200 px-2 py-1 text-xs font-medium text-gray-700 shadow-sm";
    ...
    return (
        <div className="mt-2 flex flex-col gap-3">
            ...
            {!loading && !country && !email && !phone && !instagram && <div className="text-xs text-gray-400">No info provided</div>}
        </div>
    );
};
